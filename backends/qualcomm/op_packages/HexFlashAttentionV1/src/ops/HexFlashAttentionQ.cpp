...
static float hexflashattentionqCostFunc(const Op* op);
 ...
 * DEF_PACKAGE_OP_AND_COST_AND_FLAGS((hexflashattentionqImpl<PlainFloatTensor>),
 * "HexFlashAttentionQ", SNAIL)
 */
 ...
 * e.g.
 * DEF_PACKAGE_OP_AND_COST_F_AND_FLAGS((hexflashattentionqImpl<PlainFloatTensor>),
 * "HexFlashAttentionQ", hexflashattentionqCostFunc, Flags::RESOURCE_HVX)
 */
...
__attribute__((unused)) static float hexflashattentionqCostFunc(const Op* op) {
  /*
   * add code here
   * */
