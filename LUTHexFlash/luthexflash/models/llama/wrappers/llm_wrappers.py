...
from luthexflash.models.llama.decoder_utils import (
    graph_module_inference,
)
from luthexflash.models.llama.encoder.encoder_config import (
    GraniteSpeechEncoder,
)
from luthexflash.models.llama.encoder.encoder_quant_recipe import (
    EncoderQuantRecipe,
)
from luthexflash.models.llama.mix_precision_analyzer import (
    PerLayerSqnrAnalyzer,
    save_suggest_recipes,
)
from luthexflash.models.llama.model.embedding import (
    TokenEmbedding,
)
...
class HybridTextDecoder(Component):
    ...
    def _encoding_override(self, decode_model, prefill_model):  # noqa: C901
        ...
        def compare_nodes(decode_node, prefill_node):
            ...
            assert info(decode_node) == info(prefill_node), (
