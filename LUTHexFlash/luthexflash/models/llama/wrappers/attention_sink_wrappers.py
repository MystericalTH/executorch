...
from luthexflash.models.llama import LLMModelConfig
from luthexflash.models.llama.decoder_constants import (
    ATTENTION_SINK_EVICTOR,
    DECODER_GRAPH_NAMES,
)
from luthexflash.models.llama.model.static_llama import (
    AttentionSinkRope,
    ModelArgs,
)
from luthexflash.models.llama.static_llm_quant_recipe import (
...
def is_attention_sink_config_equal(
    ...
    assert os.path.exists(attention_sink_evictor_pte_path), (
...
class AttentionSinkEvictor(Component):
    ...
    def _prepare_model(self) -> AttentionSinkRope:
        ...
        assert eviction_batch_size + sink_size <= self.model_args.max_context_len, (
...
class HybridAttentionSinkEvictor(Component):
    ...
    def quantize(
        ...
        assert os.path.exists(text_decoder_pte_path), (
