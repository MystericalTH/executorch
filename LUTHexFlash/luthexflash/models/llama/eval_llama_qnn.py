...
from pytorch_tokenizers import TiktokenTokenizer, get_tokenizer
...
from luthexflash.models.llama import SUPPORTED_LLM_MODELS
...
from luthexflash.models.llama.range_setting_pt2e import (
    WrappedLlamaModel,
    compute_scales,
...
def prepare_tokenizer(args):
    ...
    if args.decoder_model in {"stories110m", "stories260k"}:
        ...
        assert args.tokenizer_bin is not None, (
            ...
            with torch.no_grad():
                ...
                while pos < num_tokens:
                    ...
                    tmp_pos[0, :num_tokens_in_chunk] = all_pos[
                        0,
                        input_pos + position_shift : input_pos
                        + position_shift
                        + num_tokens_in_chunk,
                    ]
