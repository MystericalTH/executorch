...
GraphStatus examplecustomopImpl(TensorType& out_0,
 ...
 * e.g. DEF_PACKAGE_OP((examplecustomopImpl<Tensor>), "ExampleCustomOp")
 */
 ...
 * e.g. DEF_PACKAGE_OP_AND_COST_AND_FLAGS((examplecustomopImpl<PlainFloatTensor>), "ExampleCustomOp", SNAIL)
 */
 ...
 * e.g. DEF_PACKAGE_OP_AND_COST_F_AND_FLAGS((examplecustomopImpl<PlainFloatTensor>),
